...
def addinchikey(excelpathin, excelpathout):
    ...
    CD = pd.DataFrame(CD, columns=['Structure', 'Name', 'Formula']) # for testing can change CD to CD[:10]
...
if __name__ == "__main__":
    ...
    addinchikey(r'D:/BCDD/Documents/Tal/Projects/HMDB/DataSets/MOD_REINJ_NEG_ChemSpider Results.xlsx',
                'D:/BCDD/Documents/Tal/Projects/HMDB/DataSets/MOD_REINJ_NEG_ChemSpider ResultsW 3cols.xlsx')